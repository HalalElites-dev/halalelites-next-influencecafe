...
const BestSelling = () => {
    return (
        <section id="menu" className='relative overflow-visible bg-white'>
             <div className="hidden xl:block absolute top-50 -left-95 transform -translate-y-1/2 rotate-45 z-50">
                    <Image
                      src="/hero.webp"
                      alt="Cup"
                      width={600}
            ...
            <div className=' bg-brand-secondary relative -pb-30'>
                        ...
                        <div className='flex items-end pb-16 lg:pb-20'>
                            <div className='bg-white rounded-2xl p-6  w-full'>
                                <div className='flex items-start gap-3 mb-4'>
                                    <svg className='w-10 h-10 text-brand-secondary flex-shrink-0 opacity-40' fill="currentColor" viewBox="0 0 100 93" xmlns="http://www.w3.org/2000/svg">
